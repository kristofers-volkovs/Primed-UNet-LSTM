import torch
import numpy as np
from models.model_blocks import ResBlock, CellLSTM
...
class Model(torch.nn.Module):
    ...
    def init_hidden(self, batch_size):
        # For parallel processing (batch_size, num_layers, hidden_dim)
        hidden_rnn = torch.zeros(batch_size, self.len_layers_rnn, self.size_lstm_in_prod)
        state_rnn = torch.zeros(batch_size, self.len_layers_rnn, self.size_lstm_in_prod)
